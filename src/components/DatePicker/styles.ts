import { DatePickerInput } from 'mantine-dates-6';
import { defaultTransition } from '@/styles/theme';
import styled from '@emotion/styled';

const Container = styled(DatePickerInput)`
  position: relative;
  ...
  .mantine-Popover-dropdown {
    ...
    * {
    ...
    .mantine-DatePickerInput-monthLevel,
    .mantine-DatePickerInput-decadeLevel,
    .mantine-DatePickerInput-yearLevel {
      width: 100%;
